    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='omo_mursi.Taxon')),
                ('rank', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='omo_mursi.TaxonRank')),
            ],
            options={
                'verbose_name': 'Taxon',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon', models.ForeignKey(default=0, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='omo_mursi_biology_occurrences', to='omo_mursi.Taxon')),
            ],
            options={
