...
wtap_default_list_display = ('barcode', 'date_recorded', 'catalog_number', 'basis_of_record', 'item_type',
                             'collecting_method', 'collector', 'item_scientific_name', 'item_description',
                             'year_collected', 'in_situ', 'problem', 'easting', 'northing')

wtap_default_readonly_fields = ('id', 'point_x', 'point_y', 'easting', 'northing', 'date_last_modified', 'thumbnail')

wtap_search_fields = ('id',
                      'basis_of_record',
                      'item_type',
                      'barcode',
                      'collection_code',
...
class OccurrenceAdmin(PaleoCoreOccurrenceAdmin):
    ...
    list_display = wtap_default_list_display + ('thumbnail',)  # defaults plus thumbnail
    ...
    readonly_fields = wtap_default_readonly_fields + ('photo',)  # defaults plus photo
    search_fields = wtap_search_fields
