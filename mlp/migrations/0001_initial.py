# Generated by Django 2.2.5 on 2020-03-11 22:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collector', models.CharField(blank=True, choices=[('Zeresenay Alemseged', 'Zeresenay Alemseged'), ('Yared Asseffa', 'Yared Assefa'), ('Andrew Barr', 'Andrew Barr'), ('Rene Bobe', 'Rene Bobe'), ('Denis Geraads', 'Denis Geraads'), ('Tomas Getachew', 'Tomas Getachew'), ('Waldeyared Hailu', 'Waldeyared Hailu'), ('Shannon McPherron', 'Shannon McPherron'), ('Denne Reed', 'Denne Reed'), ('Peter Stamos', 'Peter Stamos'), ('Jonathan Wynn', 'Jonathan Wynn')], max_length=50, null=True)),
                ...
                ('field_season', models.CharField(blank=True, choices=[('Jan 2014', 'Jan 2014'), ('Nov 2014', 'Nov 2014'), ('Nov 2015', 'Nov 2015'), ('Jan 2018', 'Jan 2018'), ('Jan 2019', 'Jan 2019'), ('Jan 2020', 'Jan 2020')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mlp.Taxon')),
                ('rank', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mlp.TaxonRank')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identified_by', models.CharField(blank=True, choices=[('Zeresenay Alemseged', 'Zeresenay Alemseged'), ('Yared Asseffa', 'Yared Assefa'), ('Andrew Barr', 'Andrew Barr'), ('Rene Bobe', 'Rene Bobe'), ('Denis Geraads', 'Denis Geraads'), ('Tomas Getachew', 'Tomas Getachew'), ('Waldeyared Hailu', 'Waldeyared Hailu'), ('Shannon McPherron', 'Shannon McPherron'), ('Denne Reed', 'Denne Reed'), ('Peter Stamos', 'Peter Stamos'), ('Jonathan Wynn', 'Jonathan Wynn')], max_length=100, null=True)),
                ...
                ('taxon', models.ForeignKey(default=0, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='mlp_biology_occurrences', to='mlp.Taxon')),
            ],
            options={
